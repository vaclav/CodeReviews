...
public class ShowCodeReviews_Action extends BaseAction {
  private static final Icon ICON = null;

  public ShowCodeReviews_Action() {
    super("Show Code Reviews", "Changes the projection to make code reviews visible", ICON);
